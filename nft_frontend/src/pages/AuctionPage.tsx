...
const AuctionPage: React.FC = () => {
    ...
    return (
        <div className="p-5">
            <h1 className="mb-12 flex flex-col items-center pt-8 bg-gradient-to-r from-purple-500 to-sky-500 text-transparent bg-clip-text inline-block">NFT IN ASTA</h1>
